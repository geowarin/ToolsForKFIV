...
public class SceneNodeStaticMesh : ISceneNode
{
    ...
    public void Draw(SceneDraw flags, Vector3f position, Vector3f rotation, Vector3f scale)
    {
        ...
        int currentProgram = OpenTK.Graphics.OpenGL.GL.GetInteger(GetPName.CurrentProgram);
        int worldMatrixLoc = OpenTK.Graphics.OpenGL.GL.GetUniformLocation(currentProgram, "worldMatrix");
        OpenTK.Graphics.OpenGL.GL.UniformMatrix4(worldMatrixLoc, false, ref Transform);
